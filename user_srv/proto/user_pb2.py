...
_PASSWORDCHECKINFO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='encryptPassword', full_name='PasswordCheckInfo.encryptPassword', index=1,
...
_CREATEUSERINFO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='nick_name', full_name='CreateUserInfo.nick_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MOBILEREQUES = _descriptor.Descriptor(
  name='MobileReques',
  full_name='MobileReques',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='mobile', full_name='MobileReques.mobile', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_IDREQUESTS = _descriptor.Descriptor(
  name='IdRequests',
  full_name='IdRequests',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='IdRequests.id', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_USERINFORESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='nickName', full_name='UserInfoResponse.nickName', index=6,
...
DESCRIPTOR.message_types_by_name['MobileReques'] = _MOBILEREQUES
DESCRIPTOR.message_types_by_name['IdRequests'] = _IDREQUESTS
...
MobileReques = _reflection.GeneratedProtocolMessageType('MobileReques', (_message.Message,), {
  'DESCRIPTOR' : _MOBILEREQUES,
  '__module__' : 'user_pb2'
  # @@protoc_insertion_point(class_scope:MobileReques)
  })
_sym_db.RegisterMessage(MobileReques)

IdRequests = _reflection.GeneratedProtocolMessageType('IdRequests', (_message.Message,), {
  'DESCRIPTOR' : _IDREQUESTS,
  '__module__' : 'user_pb2'
  # @@protoc_insertion_point(class_scope:IdRequests)
  })
_sym_db.RegisterMessage(IdRequests)
